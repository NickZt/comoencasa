...
public abstract class CameraActivity extends AppCompatActivity
  ...
  public boolean isInIngredientList(String[] ingredientList, String ingredient){

    boolean out = false;
    for(String s: ingredientList) {
      if(s.equals(ingredient)) {
        out = true;
        Log.v("isInIngredientList", "TRUE");
      }
    }
    return out;
  ...
  protected void showResultsInBottomSheet(List<Recognition> results) {
    if (results != null && results.size() >= 3) {
      ...
      if (recognition != null) {
        ...
        if (recognition.getConfidence() != null && isInIngredientList(Utils.ingredientList,recognition.getTitle()))
      ...
      if (recognition1 != null) {
        ...
        if (recognition1.getConfidence() != null && isInIngredientList(Utils.ingredientList,recognition.getTitle()))
      ...
      if (recognition2 != null) {
        ...
        if (recognition2.getConfidence() != null && isInIngredientList(Utils.ingredientList,recognition.getTitle()))
